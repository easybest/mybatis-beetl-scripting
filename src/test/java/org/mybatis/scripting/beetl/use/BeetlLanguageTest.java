...
package org.mybatis.scripting.beetl.use;
 ...
 * @author Jarvis Song
 */
public class BeetlLanguageTest {
    ...
    public static void setUp() throws Exception {
        ...
        try {
            ...
            Reader reader = Resources.getResourceAsReader("org/mybatis/scripting/beetl/use/CreateDB.sql");
            ...
            reader = Resources.getResourceAsReader("org/mybatis/scripting/beetl/use/MapperConfig.xml");
    ...
    public void testDynamicSelectWithPropertyParams() {
        ...
        try {
            ...
            List<Name> answer = sqlSession.selectList("org.mybatis.scripting.beetl.use.selectNames", p);
            ...
            answer = sqlSession.selectList("org.mybatis.scripting.beetl.use.selectNames", p);
            assertEquals(3, answer.size());
            for (Name n : answer) {
    ...
    public void testDynamicSelectWithExpressionParams() {
        ...
        try {
            ...
            Parameter p = new Parameter(true, "Fli");
            List<Name> answer = sqlSession.selectList("org.mybatis.scripting.beetl.use.selectNamesWithExpressions", p);
            assertEquals(3, answer.size());
            for (Name n : answer) {
                assertEquals("Flintstone", n.getLastName());
            }
            ...
            p = new Parameter(false, "Fli");
            answer = sqlSession.selectList("org.mybatis.scripting.beetl.use.selectNamesWithExpressions", p);
            assertEquals(3, answer.size());
            for (Name n : answer) {
                assertTrue(n.getLastName() == null);
            }
    ...
    public void testSelectNamesWithFormattedParam() {
        ...
        try {
            ...
            Parameter p = new Parameter(true, "Fli");
            List<Name> answer = sqlSession.selectList("org.mybatis.scripting.beetl.use.selectNamesWithFormattedParam", p);
            assertEquals(3, answer.size());
            for (Name n : answer) {
                assertEquals("Flintstone", n.getLastName());
            }
    ...
    public void testSelectNamesWithFormattedParamSafe() {
        ...
        try {
            ...
            Parameter p = new Parameter(true, "Fli");
            List<Name> answer = sqlSession.selectList("org.mybatis.scripting.beetl.use.selectNamesWithFormattedParamSafe", p);
            assertEquals(3, answer.size());
            for (Name n : answer) {
                assertEquals("Flintstone", n.getLastName());
            }
    ...
    public void testDynamicSelectWithIteration() {
        ...
        try {
            ...
            param.put("ids", ids);
            List<Name> answer = sqlSession.selectList("org.mybatis.scripting.beetl.use.selectNamesWithIteration", param);
            assertEquals(3, answer.size());
    ...
    public void testTrim() {
        ...
        try {
            ...
            Map<String, int[]> param = new HashMap<String, int[]>();
            param.put("ids", ids);
            List<Name> answer = sqlSession.selectList("org.mybatis.scripting.beetl.use.selectWithTrim", param);
            assertEquals(5, answer.size());
    ...
    public void testDynamicSelectWithIterationOverMap() {
        ...
        try {
            ...
            param.put("ids", ids);
            List<Name> answer = sqlSession.selectList("org.mybatis.scripting.beetl.use.selectNamesWithIterationOverMap", param);
            assertEquals(3, answer.size());
            for (Name n : answer) {
    ...
    public void testDynamicSelectWithIterationComplex() {
        ...
        try {
            ...
            List<Name> answer = sqlSession.selectList("org.mybatis.scripting.beetl.use.selectNamesWithIterationComplex", param);
            assertEquals(3, answer.size());
    ...
    public void testSelectKey() {
        ...
        try {
            ...
            sqlSession.insert("org.mybatis.scripting.beetl.use.insertName", fred);
    ...
    public void testSelectWithCustomUserDirective() {
        ...
        try {
            Map<String, List<Name>> param = new HashMap<String, List<Name>>();
            List<Name> answer = sqlSession.selectList("org.mybatis.scripting.beetl.use.selectWithCustomUserDirective", param);
            assertEquals(5, answer.size());
        } finally {
            sqlSession.close();
        }
    ...
    public void testDynamicSelectWithInDirectiveForOneThousandPlusOne() {
        ...
        try {
            ...
            List<Name> answer = sqlSession
                    .selectList(
                            "org.mybatis.scripting.beetl.use.selectNamesWithInDirective",
                            param);
            assertEquals(5, answer.size());
        } finally {
            sqlSession.close();
